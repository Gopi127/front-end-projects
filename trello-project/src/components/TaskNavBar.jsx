...
import StarTooltip from "./tooltips/StarTooltip";
...
export default function TaskNavBar() {
  ...
  return (
    <div className="bg-taskNavBgColor h-14 flex justify-between items-center gap-[4px]">
      <div className="flex gap-1">
        <div className="w-[175px] h-[35px] flex justify-center items-center rounded-[5px] font-bold hover:bg-titleHoverColor ml-3">
          <h3 className="text-titleColor">Project Management</h3>
        </div>
        <StarTooltip text="click to star or unstar this board. Starred board show up at the top of your board list">
          <button className="w-[35px] h-[35px] hover:bg-gridHoverColor flex justify-center items-center rounded-[5px]">
            <span>
              {favorite ? (
                <svg
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="text-titleColor hover:text-starColor"
        ...
        <SideBar text="change visibility">
          <button className="w-[35px] h-[35px] hover:bg-gridHoverColor flex justify-center items-center rounded-[5px]">
            <svg
              width="20"
              height="20"
        ...
        <div className="flex justify-center items-center bg-boardColor hover:bg-titleColor w-[90px] h-[35px] rounded-[3px] gap-2">
          <svg
            width="20"
            height="20"
            role="presentation"
        ...
        <div className="w-[35px] h-[35px] hover:bg-gridHoverColor flex justify-center items-center rounded-[5px] text-titleColor">
          <FontAwesomeIcon icon={faAngleDown} />
        </div>
      </div>
      <div className="flex justify-start items-center gap-1">
        <div className="flex justify-center items-center">
          <span className="w-[35px] h-[35px] hover:bg-gridHoverColor flex justify-center items-center rounded-[3px] text-titleColor">
            <svg
              width="20"
              height="20"
              role="presentation"
        ...
        <div className="flex justify-center items-center gap-[5px] w-[85px] h-[35px] hover:bg-gridHoverColor rounded-[3px]">
          ...
          <p className="text-titleColor">Filters</p>
        </div>
        <div className="border-l border-titleColor h-5 flex justify-start items-center pl-2 pr-2 gap-2">
          <div className="text-profileColor bg-profileBgColor hover:bg-opacity-80 rounded-full w-7 h-7 flex justify-center items-center">
            <p className="text-xs font-bold">MG</p>
          </div>
          <div className="flex justify-center items-center w-[80px] h-[35px] rounded-[3px] bg-boardColor hover:bg-titleColor">
            <span>
              <svg
                width="20"
                height="20"
          ...
          <div className="w-[35px] h-[35px] flex justify-center items-center hover:bg-gridHoverColor rounded-[3px]">
            <span className="text-boardColor">
              <svg
                width="24"
                height="24"
                role="presentation"
